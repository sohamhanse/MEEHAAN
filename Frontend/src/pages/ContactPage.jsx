                  ...
                  <div className="bg-white rounded-xl shadow-md p-6">
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-gray-900">10:00 AM - 2:00 PM IST</span>
                      </div>
                      <div className="flex justify-between">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">Headquarters & Manufacturing</p>
            ...
            >
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">Sales & Distribution Center</p>
                <p className="text-gray-600 text-sm">
            ...
            >
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Germany</h3>
                <p className="text-gray-700 mb-4">Manufacturing & R&D</p>
                <p className="text-gray-600 text-sm">
